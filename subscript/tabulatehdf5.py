...
class nodeProperties(UserDict):
    ...
    def __init__(self, d, nodefilter=None):
...
def tabulate_nodes(gout:h5py.File, key_index:int=-1, custom_dsets:Callable = None, **kwargs)->nodeProperties:
    ...
    props = nodeProperties(get_cdsets(outn) | nodedata)
